...
import { calcularTablaGrupo } from '@/lib/calcularPosiciones'
...
export default function Grupos() {
  ...
  const posiciones = calcularTablaGrupo(partidosGrupo, equiposGrupo)
  const hayResultados = partidosGrupo.length > 0
